...
from Tkinter import StringVar, IntVar, Frame, Menu, Label, Canvas, Scrollbar, Checkbutton
...
class Application(Frame, object):
    ...
    def file_open(self):
        ...
        try:
            self.path.set(tkFileDialog.askopenfile(parent=self.master, **self.FILE_OPEN_OPTIONS).name)
